...
<template>
  <div class="spell-sheet box">
    ...
    <div class="spell-list">
      ...
      <h5>
        Livello 1 (Slot: {{ spellData.slots.level1.used }} / {{ spellData.slots.level1.total }})
      </h5>
      <ul>
        <li
          v-for="spell in spellData.spells.level1"
          :key="spell.name"
      ...
      <h5>
        Livello 2 (Slot: {{ spellData.slots.level2.used }} / {{ spellData.slots.level2.total }})
      </h5>
      <ul>
        <li
          v-for="spell in spellData.spells.level2"
          :key="spell.name"
          :class="{ prepared: spell.prepared }"
        >
          {{ spell.name }}
