  ...
  switch(type) {
    case 'Mostro':
      jsonStructure = `{
        ...
        "ac": number, "ac_type": "string", "hp": number, "hp_dice": "string", "speed": "string (in metri)",
        "ability_scores": { "str": number, "dex": number, "con": number, "int": number, "wis": number, "cha": number },
        "skills": "string (es. 'Furtività +6, Percezione +4')",
        "senses": "string (es. 'scurovisione 18 m, Percezione passiva 14')", 
        "languages": "string (es. 'Comune, Goblin')", 
        "challenge_rating": "string (es. '1/2 (100 PE)')",
        "description": "string (descrizione fisica e lore dettagliata)",
        "image_url": "string (URL opzionale)",
        "traits": "string (un unico blocco di testo con i tratti, ogni tratto in grassetto e seguito dalla descrizione)",
        "actions": "string (un unico blocco di testo con le azioni, ogni azione in grassetto e seguita dalla descrizione)"
      }`;
    ...
    case 'PNG':
      jsonStructure = `{
        "name": "string (nome e cognome)", "size": "string", "type": "string", "alignment": "string",
        "ac": number, "ac_type": "string", "hp": number, "hp_dice": "string", "speed": "string (in metri)",
        "ability_scores": { "str": number, "dex": number, "con": number, "int": number, "wis": number, "cha": number },
        "skills": "string", "senses": "string", "languages": "string", 
        "challenge_rating": "string",
        "description": "string (descrizione fisica dettagliata e background del personaggio)",
        "dm_prompt": "string (uno spunto di trama, un segreto o una missione legata al PNG, visibile solo al DM)",
        "image_url": "string (URL opzionale)",
        "traits": "string",
        "actions": "string"
      }`;
